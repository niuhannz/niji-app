...
const translations = {
  ...
  'profile.editProfile': { en: 'Edit Profile', ja: 'プロフィール編集' },
  'profile.memberSince': { en: 'Member since', ja: '入会日' },
  'profile.subscription': { en: 'Subscription', ja: 'サブスクリプション' },
  'profile.free': { en: 'Free', ja: '無料' },
  'profile.basic': { en: 'Basic', ja: 'ベーシック' },
  'profile.premium': { en: 'Premium', ja: 'プレミアム' },
  'profile.upgrade': { en: 'Upgrade Plan', ja: 'プランをアップグレード' },
  'profile.activity': { en: 'Activity', ja: 'アクティビティ' },
  'profile.myList': { en: 'My List', ja: 'マイリスト' },
  'profile.continueReading': { en: 'Continue Reading', ja: '続きを読む' },
  'profile.continueWatching': { en: 'Continue Watching', ja: '続きを見る' },
  'profile.stats': { en: 'Stats', ja: '統計' },
  'profile.liked': { en: 'Liked', ja: 'いいね' },
  'profile.saved': { en: 'Saved', ja: '保存' },
  'profile.following': { en: 'Following', ja: 'フォロー中' },
  'profile.projects': { en: 'Projects', ja: 'プロジェクト' },
  'profile.watched': { en: 'Watched', ja: '視聴済み' },

  // Settings
  'settings.title': { en: 'Settings', ja: '設定' },
  'settings.appearance': { en: 'Appearance', ja: '外観' },
  'settings.darkMode': { en: 'Dark Mode', ja: 'ダークモード' },
  'settings.darkModeDesc': { en: 'Always on for the best viewing experience', ja: '最高の視聴体験のため常にオン' },
  'settings.reduceMotion': { en: 'Reduce Motion', ja: 'モーションを軽減' },
  'settings.reduceMotionDesc': { en: 'Minimize animations throughout the app', ja: 'アプリ全体のアニメーションを最小化' },
  'settings.language': { en: 'Language', ja: '言語' },
  'settings.languageDesc': { en: 'Choose your preferred language', ja: '言語を選択' },
  'settings.playback': { en: 'Playback', ja: '再生' },
  'settings.autoplay': { en: 'Autoplay Next', ja: '自動再生' },
  'settings.autoplayDesc': { en: 'Automatically play the next episode', ja: '次のエピソードを自動再生' },
  'settings.skipIntro': { en: 'Auto Skip Intro', ja: 'イントロを自動スキップ' },
  'settings.skipIntroDesc': { en: 'Automatically skip opening sequences', ja: 'オープニングを自動スキップ' },
  'settings.defaultQuality': { en: 'Default Quality', ja: 'デフォルト画質' },
  'settings.notifications': { en: 'Notifications', ja: '通知' },
  'settings.newEpisodes': { en: 'New Episodes', ja: '新エピソード' },
  'settings.newEpisodesDesc': { en: 'Get notified when new episodes drop', ja: '新エピソード公開時に通知' },
  'settings.recommendations': { en: 'Recommendations', ja: 'おすすめ' },
  'settings.recommendationsDesc': { en: 'Personalized content suggestions', ja: 'パーソナライズされたおすすめ' },
  'settings.creatorUpdates': { en: 'Creator Updates', ja: 'クリエイター更新' },
  'settings.creatorUpdatesDesc': { en: 'Updates from creators you follow', ja: 'フォロー中クリエイターの更新通知' },
  'settings.account': { en: 'Account', ja: 'アカウント' },
  'settings.manageSubscription': { en: 'Manage Subscription', ja: 'サブスクリプション管理' },
  'settings.dataPrivacy': { en: 'Data & Privacy', ja: 'データとプライバシー' },
  'settings.clearHistory': { en: 'Clear Watch History', ja: '視聴履歴をクリア' },
  'settings.clearHistoryDesc': { en: 'Remove all your watch history data', ja: '視聴履歴データをすべて削除' },
  'settings.about': { en: 'About', ja: 'このアプリについて' },
  'settings.version': { en: 'Version', ja: 'バージョン' },
  'settings.terms': { en: 'Terms of Service', ja: '利用規約' },
  'settings.privacy': { en: 'Privacy Policy', ja: 'プライバシーポリシー' },
